use utf8;
package Juleol::Schema::Result::ScoreSmells;
...
=head1 TABLE: C<score_smell>

=cut

__PACKAGE__->table("score_smell");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:xLx71Auy7ZqiUPYXw7fGbA
