use utf8;
package Juleol::Schema::Result::ScoreLooks;
...
=head1 TABLE: C<score_look>

=cut

__PACKAGE__->table("score_look");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:u8kUkr6kNf/I3kCP2vHOjQ
