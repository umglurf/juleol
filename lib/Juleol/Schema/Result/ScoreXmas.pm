use utf8;
package Juleol::Schema::Result::ScoreXmas;
...
=head1 TABLE: C<score_xmas>

=cut

__PACKAGE__->table("score_xmas");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:li1idjqLZaVlyPjYTR7WBw
