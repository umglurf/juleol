use utf8;
package Juleol::Schema::Result::ScoreAftertastes;
...
=head1 TABLE: C<score_aftertaste>

=cut

__PACKAGE__->table("score_aftertaste");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:vvWj8DsdjyAQTnB1pGR0ug
